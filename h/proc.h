...
struct	pentry	{
	...
	int	pwaitret;
	int	quantum;		/* Quantum left for the process in an epoch */
	int 	queue;			/* Real Queue or Normal Queue	*/
	int 	epoch;			/* Process added in middle of an epoch or not */
	int 	newprio;		/* newprio if prio has been changed */
};
